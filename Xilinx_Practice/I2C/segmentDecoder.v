        ...
        if(reset) begin
            ...
            if(mode[segSel-1] == 1'b1) begin
                case (curDigit)
                    ...
                    "8": seg = 7'b0000000; // 8
                    "9": seg = 7'b0010000; // 9
                    "A","a": seg = 7'b0001000; // A
                    "B","b": seg = 7'b0000011; // b
                    "C","c": seg = 7'b1000110; // C
                    "D","d": seg = 7'b0100001; // d
                    "E","e": seg = 7'b0000110; // E
                    "F","f": seg = 7'b0001110; // F
                    "H","h": seg = 7'b0001001; // H
                    "L","l": seg = 7'b1000111; // L
                    "O","o": seg = 7'b0100011; // o
                    "P","p": seg = 7'b0000111; // P
                    "R","r": seg = 7'b0101111; // r
                    "U","u": seg = 7'b0001100; // U
